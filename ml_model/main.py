...
def predict():
    ...
    try:
        ...
        if weather_data is None or not weather_data.get('success', True):
            print("Using dummy weather data because API call failed.")
            temperature = 20  # Example dummy temperature
            humidity = 70   # Example dummy humidity
            cloud_cover = 50 # Example dummy cloud cover
            wind_speed = 10  # Example dummy wind speed
        else:
